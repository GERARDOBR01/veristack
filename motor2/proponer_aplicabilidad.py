...
Principio clave (Gerardo, 19 Jul): la Gran Demo es solo la campaña base —
...
VOCAB_ELEMENTOS = [
    ...
    # Mercadep), no el mueble mesa — el patrón \bMESAS?\b los caza igual; en la
    ...
    return {
        "meta": {
            ...
            "nota": ("PROPUESTAS, no decisiones. decision_gerardo: null=pendiente, "
                     ...
                     "etapas (la Gran Demo es solo la campaña base)."),
            "cobertura": cobertura,
        },
        "lotes": lotes,
    }
...
def autotest() -> None:
    ...
    els, _, _ = detectar_elementos("la gran demo inicia", None)
    check('"demo" NO dispara "barra"', els is None)
