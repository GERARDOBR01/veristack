...
def _preparar_metadata(
    ...
    if imagen_path:
        ...
        # coinciden canónicamente ("Gran Demo" → gran_demo_pv2026).
...
def _normalizar_grafico_a_etapa(
    ...
    """
    El gráfico muestra el nombre comercial ("Gran Demo"), no el ID técnico
    (gran_demo_pv2026) — comparar exacto siempre fallaría. Si el nombre
