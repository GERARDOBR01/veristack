...
resultados = [
    ...
    caso("(a) genérico correcto, ID de campaña", "gran_demo_pv2026", "Gran Demo",
         "grafico_etapa", Severidad.CUMPLE),
    # (b) gráfico con % correcto → NO dispara
    caso("(b) con % correcto, ID de campaña", "gran_demo_pv2026", "Gran Demo 40%",
         "grafico_etapa", Severidad.CUMPLE),
    # (c) gráfico real incorrecto (sintético) → SÍ dispara
    caso("(c) gráfico incorrecto sintético", "gran_demo_pv2026", "Día del Padre",
    ...
    caso("UI E1 + gráfico correcto (foto real 2)", "E1", "Gran Demo",
         "grafico_etapa_no_verificable", Severidad.NO_CALIFICA),
    caso("UI E1 + gráfico con %", "E1", "Gran Demo 40%",
         "grafico_etapa_no_verificable", Severidad.NO_CALIFICA),
    ...
    caso("E1 + nombre_campana da CUMPLE", "E1", "Gran Demo 40%",
         "grafico_etapa", Severidad.CUMPLE, nombre_campana="gran_demo_pv2026"),
    # La substitución NO ciega los mismatches reales.
    caso("E1 + nombre_campana + grafico ajeno da GRAVE", "E1", "Día del Padre",
         "grafico_etapa_incorrecta", Severidad.GRAVE, nombre_campana="gran_demo_pv2026"),
    # Slogan completo del gráfico real
    caso("slogan completo correcto", "gran_demo_pv2026", "Vive la GRAN DEMO",
         "grafico_etapa", Severidad.CUMPLE),
    ...
    caso("primavera_2024 vs verano_2025", "verano_2025", "primavera_2024",
         "grafico_etapa_incorrecta", Severidad.GRAVE),
    # Guards intactos
    caso("sin gráfico detectado", "gran_demo_pv2026", None,
         "grafico_no_detectado", Severidad.NO_CALIFICA),
    caso("sin etapa activa", None, "Gran Demo",
